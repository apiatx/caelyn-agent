        ...
        <div className="relative z-10 max-w-[95vw] mx-auto px-2 sm:px-3">
          <div className="flex justify-between items-center py-3 lg:py-4">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full overflow-hidden border-2 border-purple-400 shadow-lg bg-black/50 flex items-center justify-center">
                <img 
                  src={solanaLogo}
                  alt="Solana"
              ...
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white drop-shadow-lg">Solana Network</h1>
                <p className="text-sm sm:text-base text-white/70 font-medium mt-1">Live Solana network analytics with DexScreener, Jupiter, and Moby Screener</p>
              </div>
            </div>
