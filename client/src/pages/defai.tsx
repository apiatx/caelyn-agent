        ...
        <div className="relative z-10 max-w-[95vw] mx-auto px-2 sm:px-3">
          <div className="flex items-center justify-center py-3 lg:py-4">
            ...
            <div className="text-center flex-1">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white via-blue-200 to-cyan-200 bg-clip-text text-transparent">DeFAI</h1>
              <p className="text-sm sm:text-base text-white/70 font-medium mt-1">AI-Powered DeFi Analytics & Protocols</p>
            </div>
